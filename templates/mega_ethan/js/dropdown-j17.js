/**
 # mega_alatinum - Mega EThan Template for Joomla! 1.7
...
**/
/**------------------------------------------------------------------------
 * file: dropdown-j17.js 1.6.0 00001, April 2011 12:00:00Z OmegaTheme $
 * package:	Mega EThan Template 
 *------------------------------------------------------------------------*/
if (typeof(MooTools) != 'undefined') {
	...
	var DropdownMenu = new Class({
		...
		window.addEvent('domready', function() {
			new DropdownMenu(document.getElement('#main-nav ul.level0'));
		});
} else {
	sfHover = function()
	{
