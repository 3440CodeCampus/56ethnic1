...
CKEDITOR.plugins.setLang('jtreelink','es',
{
	jtreelink :
	{
		...
		popupResizable	: 'De tamaño variable',
		popupStatusBar	: 'La barra de estado',
		popupLocationBar: 'Localización Bar',
		...
		popupWidth		: 'Ancho',
		popupLeft		: 'Posición a la izquierda',
		popupHeight		: 'Altura',
		popupTop		: 'Subir',
		id				: 'Id',
		langDir			: 'Idioma Dirección',
